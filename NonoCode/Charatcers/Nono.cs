...
[RegisterCharacter]
public class NonoCharacter : ModCharacterTemplate<NonoCardPool, NonoRelicPool, NonoPotionPool>
{
    public const string CharacterId = "Nono";

    public static readonly Color Color = new("7FFFD4");
    // 角色名称颜色
    ...
    public override CharacterAssetProfile AssetProfile => CharacterAssetProfiles.Merge(
        ...
        new(
            Scenes: new(
                // 人物模型tscn路径。
                VisualsPath: "res://Nono/Scenes/nono.tscn"
                // 能量表盘tscn路径。
            ...
            Ui: new(
                ...
                // 人物选择背景。
                CharacterSelectBgPath: "res://Nono/Scenes/nono_bg.tscn",
                // 人物选择图标。
